...
class _AddOrderFormState extends State<AddOrderForm> {
  ...
  @override
  Widget build(BuildContext context) {
    // This makes the sheet move up when keyboard opens
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          // 2. SIZE SELECTION (Optional Chips)
          ...
          // 5. DUE DATE OPTION (No 'intl' package needed)
          InkWell(
            onTap: _pickDate,
            borderRadius: BorderRadius.circular(12),
            child: Container(
              ...
              child: Row(
                children: [
                  ...
                  Text(
                    dueDate == null
                        ? "Select Due Date"
                        : "Due: ${dueDate!.day}/${dueDate!.month}/${dueDate!.year}", // Manual Formatting
                    style: TextStyle(
